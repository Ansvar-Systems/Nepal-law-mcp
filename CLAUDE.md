# Nepal Law MCP Server — Developer Guide
...
Nepal Law MCP server providing Nepalese legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Nepal uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Nepal Law -> JSON seed files in `data/seed/`
...
- Nepal uses a common law legal system inherited from British colonial administration
- The Constitution of Nepal 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Nepal 2010"
...
- npm package: `@ansvar/nepal-law-mcp` with bin entry for stdio
