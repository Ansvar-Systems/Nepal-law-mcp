# Nepalese Law MCP Server

**The Nepal Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/nepal-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/nepal-law-mcp)
...
Query **494 Nepalese Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Nepal, and more -- directly from Claude, Cursor, or any MCP-compatible client.

If you're building legal tech, compliance tools, or doing Nepalese legal research, this is your verified reference database.
...
Nepalese legal research is scattered across Nepal Law Reports, the Nepal Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Nepalese law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Nepalese legislation
- A **researcher** tracing legislative history from colonial-era statutes to the 2010 Constitution

...you shouldn't need dozens of browser tabs and manual PDF cross-referencing. Ask Claude. Get the exact provision. With context.

This MCP server makes Nepalese law **searchable, cross-referenceable, and AI-readable**.
...
**Endpoint:** `https://nepal-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add nepal-law --transport http https://nepal-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "nepal-law": {
      "type": "url",
      "url": "https://nepal-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Nepal say about the right to privacy?"*
- *"Search for data breach notification requirements in Nepalese law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Nepal"*
...
| **Nepal Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Nepal |
...
| **Constitution of Nepal** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Nepalese federal legislation)
...
| `format_citation` | Format citations per Nepalese conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Nepalese statute |
| `get_nepalese_implementations` | Find Nepalese laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Nepalese implementation counts |
...
- All statute text is ingested from official Nepalese government sources
...
All content is sourced from authoritative Nepalese legal databases:

- **[Nepal Law Reports](https://nepallaw.org)** -- Official Nepalese government legal database
...
>
> Statute text is sourced from official Nepalese government publications. However:
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Nepal, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{nepal_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Nepalese Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Nepal-law-mcp},
  note = {Nepalese legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Nepalese Government (public domain)
